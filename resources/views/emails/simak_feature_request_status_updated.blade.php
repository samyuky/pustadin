...
<html>
<head>
    <title>Status Permintaan Fitur SIMAK Diperbarui</title>
    <style>
...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Halo {{ $request->requester_name }},</p>
            
            <p>Status permintaan Fitur SIMAK Anda telah diperbarui:</p>
            
            <ul>
                <li><strong>ID Permintaan:</strong> {{ $request->id }}</li>
                <li><strong>Subjek:</strong> {{ $request->feature_name }}</li>

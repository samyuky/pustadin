...
<html>
<head>
    <title>Status Laporan Error Diperbarui</title>
    <style>
...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Halo {{ $errorReport->requester_name }},</p>
            
            <p>Status Laporan Error Anda telah diperbarui:</p>
            <ul>
                <li><strong>ID Permintaan:</strong> {{ $errorReport->id }}</li>
                <li><strong>Judul:</strong> {{ $errorReport->title }}</li>
